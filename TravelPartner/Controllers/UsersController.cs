...
namespace TravelPartner.Controllers
{
    ...
    {
        private TravelPartnerContext db = new TravelPartnerContext();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,Firstname,Lastname,Email,Password,ConfirmPassword")] User user)
        {
